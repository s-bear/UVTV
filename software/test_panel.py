...
target_color = [0.5,0.5,0.5,0.0,0.0]
img[row[0],col[0]] = target_color

#Blue training 

#img[1,7] = [0.024, 0.026, 0.95, 0.00011, 0.000079]
#img[1,1] = [0.024, 0.026, 0.95, 0.00011, 0.000079]
...
#img[1,7] = [0.7, 0.75, 0.3, 0.0033, 0.011]
#img[1,1] = [0.7, 0.75, 0.3, 0.0033, 0.011]
#img[1,5] = [0.7, 0.75, 0.3, 0.0033, 0.011]
#img[3,4] = [0.7, 0.75, 0.3, 0.0033, 0.011]
#img[5,3] = [0.7, 0.75, 0.3, 0.0033, 0.011]
